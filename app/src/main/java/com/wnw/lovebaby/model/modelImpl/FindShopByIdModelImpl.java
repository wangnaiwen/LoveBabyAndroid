...
public class FindShopByIdModelImpl implements IFindShopByIdModel{

    private Context context;
    private ShopFindByIdListener shopFindByIdListener;
    private Shop returnData;

    @Override
    public void findShopById(Context context, int id, ShopFindByIdListener shopFindByIdListener) {
        this.context = context;
        this.shopFindByIdListener = shopFindByIdListener;
    ...
    private void sendRequestWithVolley(int id){
        String url = NetConfig.SERVICE+NetConfig.FIND_SHOP_BY_ID
                +"id="+id;
        LogUtil.d("url", url);
    ...
    private void parseNetUserWithJSON(String response){
        try{
            ...
            JSONObject resultObject = jsonObject.getJSONObject("findShopById");
    ...
    private void retData(){
        if(shopFindByIdListener != null){
            shopFindByIdListener.complete(returnData);
        }
    }
}
