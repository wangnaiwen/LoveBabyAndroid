...
public class ImageUploadRequest extends Request<String> {
    ...
    /*请求 数据通过参数的形式传入*/
    private List<ImageForm> mListItem ;

    private String BOUNDARY = "--------------520-13-14"; //数据分隔线
    private String MULTIPART_FORM_DATA = "multipart/form-data";

    public ImageUploadRequest(String url, List<ImageForm> listItem, ResponseListener listener) {
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        for (int i = 0; i < N ;i++){
            ...
            sb.append(" name=\"");
            sb.append(imageForm.getFormName()) ;
            sb.append("\"") ;
            sb.append("; filename=\"") ;
            sb.append(imageForm.getImageName()) ;
            sb.append("\"");
            sb.append("\r\n") ;
            /*第三行*/
