package com.wnw.lovebaby.view.dialog;
...
import com.wnw.lovebaby.wheel.OnWheelChangedListener;
...
public class CityPickerDialog extends Dialog {
    ...
    private final static int DEFAULT_ITEMS = 6;
    ...
    public CityPickerDialog(Activity context, List<Province> provinces, Province defaultProvince,
                            City defaultCity, County defaultCounty, final onCityPickedListener listener){
        super(context);
        mContext = context;
    ...
    private void initViews(){
        provinceWheel = (WheelView) findViewById(R.id.province_wheel);
        citiesWheel = (WheelView) findViewById(R.id.cities_wheel);
        countiesWheel = (WheelView) findViewById(R.id.counties_wheel);
