...
import com.wnw.lovebaby.presenter.UpdateShopPresenter;
...
public class EditMyShopActivity extends Activity implements View.OnClickListener,
        IFindUserByIdView, IUpdateShopView {
    ...
    private void initView(){
        back = (ImageView)findViewById(R.id.back_edit_open_my_shop);
        nameEt = (EditText)findViewById(R.id.et_edit_open_shop_name);
        idCardEt = (EditText)findViewById(R.id.et_edit_open_shop_id_card);
        shopNameEt = (EditText)findViewById(R.id.et_edit_open_shop_shop_name);
        wechatEt = (EditText)findViewById(R.id.et_edit_open_shop_wechat);
        submitTv = (TextView)findViewById(R.id.tv_edit_submit_open_shop);
        pickInviteeRl = (RelativeLayout)findViewById(R.id.rl_edit_pick_invitee);
        disInviteeNameTv = (TextView)findViewById(R.id.tv_edit_dis_invitee_name);
    ...
    private void initPresenter(){
        updateShopPresenter = new UpdateShopPresenter(this,this);
        findUserByIdPresenter = new FindUserByIdPresenter(this, this);
    }

    private void startUpdateShop(){
        if(NetUtil.getNetworkState(this) == NetUtil.NETWORN_NONE){
            Toast.makeText(this, "暂无网路", Toast.LENGTH_SHORT).show();
        }else {
            updateShopPresenter.updateShop(shop);
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.rl_edit_pick_invitee:
                showInsertPrDialog();
                break;
            case R.id.back_edit_open_my_shop:
                finish();
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                break;
            case R.id.tv_edit_submit_open_shop:
    ...
    protected void onDestroy() {
        super.onDestroy();
        updateShopPresenter.setUpdateShopView(null);
